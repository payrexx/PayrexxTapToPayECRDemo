...
import com.payrexx.taptopay.sdk.dto.SaleDto;
import com.payrexx.taptopay.sdk.dto.TransactionHistoryDto;
import com.payrexx.taptopay.sdk.lib.operation.Sale;
import com.payrexx.taptopay.sdk.lib.operation.TransactionHistory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener(v -> {
            ...
            tapToPay.doOperation(
                new Sale(saleDto),
                response -> {
                    if (response instanceof EmptyResponse || ((SingleResponse) response).transaction == null) {
                        Toast toast = new Toast(this);
                        toast.setText("Transaction Cancelled");
                        toast.show();
                    } else {
...
//                RefundDto refundDto = new RefundDto("8c9ceee6f5f68004e93f3c760069a2c8", 0.1f);
//                tapToPay.doOperation(
//                        new Refund(refundDto),
//                        result -> {
//                            Log.d("TaptoPay", result.toString());
//                        }
//                );

//                ReceiptDto receiptDto = new ReceiptDto("42b55e97d3de94413a1f556293103212", "email", "janic.deluca@payrexx.com");
//                tapToPay.doOperation(
